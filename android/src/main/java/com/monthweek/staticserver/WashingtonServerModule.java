...
package com.monthweek.staticserver;
...
public class RNWashingtonServerModule extends ReactContextBaseJavaModule implements LifecycleEventListener {

  private final ReactApplicationContext reactContext;

  private static final String LOGTAG = "RNWashingtonServerModule";
  ...
  public RNWashingtonServerModule(ReactApplicationContext reactContext) {
    super(reactContext);
